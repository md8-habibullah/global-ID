...
interface TargetCursorProps {
  // Automatically targets links, buttons, and inputs by default
...
export default function MouseCursor({
  ...
  // We use a ref object to let GSAP animate the 'current' property
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      corners.forEach((corner, i) => {
        ...
        // Safety check if positions exist
    ...
    const scrollHandler = () => {
      ...
      // We manually check if we are still hovering because native hover states get weird on scroll
