        ...
        <div className="max-w-6xl mx-auto cursor-target">
          <div className="grid md:grid-cols-3 gap-12 mb-12 cursor-target cursor-target">
            ...
            <motion.div
              ...
              className="space-y-4 cursor-target"
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                scalable infrastructure and clean code.
              </p>
            </motion.div>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                {socialLinks.map(({ href, label, Icon }) => (
                  ...
                  >
                    ...
                    <span
                      className="ml-0 max-w-0 opacity-0 whitespace-nowrap font-semibold transition-all duration-300 ease-in-out
                                     group-hover:ml-2 group-hover:max-w-xs group-hover:opacity-100"
                    >
                      {label}
                    </span>
                    {/* Optional "terminal cursor effect" */}
                    <span className="absolute right-2 opacity-0 group-hover:opacity-100 animate-blink">
                      _
                    </span>
                  </a>
                ))}
          ...
          >
            ...
            <motion.p variants={itemVariants} className="font-light">
              © {new Date().getFullYear()} HABIBULLAH | All rights reserved.
            </motion.p>
          </motion.div>
        </div>
      </motion.div>
